...
const char *userid = "000976";            //IoTtweet account user ID (6 digits, included zero pre-fix)
const char *key = "33tqbqetxxam";     //IoTtweet registered device key in "MY IOT Garage"
const char *ssid = "itfitm";                    //Your-WiFi-router-SSID
